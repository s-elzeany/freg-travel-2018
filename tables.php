        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              ...
              <div class="add-button-float" id="changebtn">
              <button class="btn btn-primary " onclick="location.href = 'change-invoice.php';">Change invoice number</button>
            </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                ...
                <div class="card card-small mb-4">
                  ...
                  <div class="card-body p-0 pb-3 text-center">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td> <?php echo $row['data_customID']?></td>
                          <td> <?php echo $row['data_date']?></td>
                          <td> <?php echo $row['data_due']?></td>
                          <td> <?php echo $row['data_addedby']?></td>
                          <td> <?php echo $row['data_editedby']?></td>
                          <td><a onclick="editData('<?php echo $row['data_customID'];?>')"><i style="font-size:160%;" class="material-icons  setColor">create</i></a></td>
                          <td><a id= "clearbtn" onclick= "deleteData('<?php echo $row['data_customID'];?>')"><i style="font-size:180%;" class="material-icons  setColor">clear</i></a></td>
                        </tr>
                      </tbody>
                    <?php } ?>
                    </table>
...
function editData(str){
 ...
 success:function(data){
     window.location.href = "PDFedit.php";
 }
