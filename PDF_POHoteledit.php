...
session_start();
  ...
  $poh_id = $_SESSION['poh_id'];
  $poh_html = $_SESSION['poh_html'];
?>
<html class="no-js h-100" lang="en">
  ...
  airplanemode_active
              ...
              <p id="pohID" hidden><?php echo $poh_id?></p>
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Update PO Hotel</h3>
              </div>
            </div>
            <!-- End Page Header -->
...
<center>
  <button type = "button" style="margin-left:0px;" class="fg-button btn btn-primary " onclick="updateDataPOH()">Update and Continue</button>
...
<script>
 ...
 function updateDataPOH(){
   var poh_ID = $("#pohID").html();
   ...
   type:"POST",
   url:"api/update_poh.php",
  data:"CData="+CData+"&Cname="+Cname+"&dateToday="+dateToday+"&poh_ID="+poh_ID+"&mainUser="+mainUser,
