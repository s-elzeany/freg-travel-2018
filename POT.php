              ...
              <li class="nav-item">
                <a class="nav-link" href="tablesTicket.php">
                  ...
                  <span>E-Ticket List</span>
							...
							<li class="nav-item">
								<a class="nav-link active" href="POT.php">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">PO Ticket</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">PO Ticket</h6>
                  </div>
                  <div class="card-body p-0 pb-3 text-center">
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          <th scope="col" class="border-0">PO Ticket ID</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> <?php echo $row['pot_date']?></td>
                          <td> <?php echo $row['pot_name']?></td>
                          <td> <?php echo $row['pot_addedby']?></td>
                          <td> <?php echo $row['pot_editedby']?></td>
                          <td><a onclick="editData('<?php echo $row['pot_id'];?>')"><i style="font-size:160%;" class="material-icons  setColor">create</i></a></td>
                          <td><a id= "clearbtn" onclick= "deleteData('<?php echo $row['pot_id'];?>')"><i style="font-size:180%;" class="material-icons  setColor">clear</i></a></td>
                        </tr>
                      </tbody>
                    <?php } ?>
                    </table>
...
function editData(str){
 ...
 type:"POST",
 url:"api/edit_pot.php",
 data:"id="+id,
 success:function(data){
     window.location.href = "PDF_POTicketedit.php";
 }
