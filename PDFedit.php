...
session_start();
  ...
  $data_customID = $_SESSION['data_customID'];
  $data_html = $_SESSION['data_html'];
?>
...
<center>
  <button type = "button" style="margin-left:10px;" class="fg-button btn btn-primary " onclick="updateData()">Update and Continue</button>
  <button type = "button" style="margin-left:330px;" class="fg-button btn btn-primary " onclick="printDiv('Completes_data')">Print</button>
<br>
<br>
<br>
</center>
